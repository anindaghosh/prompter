...
const IMAGE_HINTS: Record<string, string[]> = {
  'img-001': ['ornate urn', 'mixed blooms', 'dark background'],
  'img-002': ['sea of clouds', 'alpine summit', 'golden hour'],
  'img-003': ['street canyon', 'golden light', 'aerial skyline'],
  'img-004': ['pink petals', 'soft bokeh', 'spring sky'],
  'img-005': ['northern lights', 'mirror reflection', 'snowy peaks'],
  'img-006': ['colorful', 'river mirror', 'low flight'],
  'img-007': ['coral reef', 'aquarium', 'pink and orange'],
  'img-008': ['red rock', 'buttes and mesas', 'American Southwest'],
  'img-009': ['satellite view', 'night lights', 'continent'],
  'img-010': ['smiling man', 'white t-shirt', 'gray background'],
  'img-011': ['neon signs', 'wet pavement', 'city at night'],
  'img-012': ['layered forms', 'blue and white', 'flowing curves'],
  'img-013': ['snow-capped peaks', 'evergreen forest', 'river valley'],
  'img-014': ['orange fur', 'golden hour', 'snowy ground'],
  'img-015': ['pendant lights', 'wooden tables', 'open staircase'],
  'img-017': ['microchips', 'copper traces', 'electronic components'],
  'img-018': ['whitewashed', 'caldera view', 'bougainvillea'],
  'img-019': ['mural', 'piercing eyes', 'colorful swirls'],
  'img-020': ['rocky gorge', 'long exposure', 'mossy cliffs'],
};
