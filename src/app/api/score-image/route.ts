...
const REFERENCE_IMAGES: Record<string, { filename: string; category: string; difficulty: string; title: string }> = {
    ...
    'img-006': { filename: 'hot-air-balloon.png', category: 'Photography', difficulty: 'Medium', title: 'Hot Air Balloons' },
    ...
    'img-012': { filename: 'abstract-waves.png', category: 'Fine Art', difficulty: 'Hard', title: 'Abstract Waves' },
