...
const tablesSchema = __schema({
  ...
  playerPowerup: __table({
    name: 'player_powerup',
    indexes: [
      { accessor: 'identity', name: 'player_powerup_identity_idx_btree', algorithm: 'btree', columns: [
        'identity',
      ] },
      { accessor: 'by_room', name: 'player_powerup_room_code_idx_btree', algorithm: 'btree', columns: [
        'roomCode',
      ] },
    ],
    constraints: [
      { name: 'player_powerup_identity_key', constraint: 'unique', columns: ['identity'] },
    ],
  }, PlayerPowerupRow),
  powerupEvent: __table({
    name: 'powerup_event',
    indexes: [
      { accessor: 'id', name: 'powerup_event_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'powerup_event_id_key', constraint: 'unique', columns: ['id'] },
    ],
    event: true,
  }, PowerupEventRow),
  room: __table({
  ...
  roundResult: __table({
    ...
    indexes: [
      ...
      { accessor: 'by_room', name: 'round_result_room_code_idx_btree', algorithm: 'btree', columns: [
        'roomCode',
      ] },
      { accessor: 'by_room_round', name: 'round_result_room_code_round_idx_btree', algorithm: 'btree', columns: [
        'roomCode',
        'round',
      ] },
    ],
  ...
  submission: __table({
    ...
    indexes: [
      ...
      { accessor: 'by_room', name: 'submission_room_code_idx_btree', algorithm: 'btree', columns: [
        'roomCode',
      ] },
      { accessor: 'by_room_round', name: 'submission_room_code_round_idx_btree', algorithm: 'btree', columns: [
        'roomCode',
        'round',
      ] },
    ],
